...
def aggregate_constructed(run_dir: str):
    # This function is a stub that collects simple counts. The full paper uses human annotations for CR and utility.
    # Here we only compute counts of BALM decision==1 and basic lengths, which you can replace with your annotation merges.
    rows = []
...
def main():
    ...
    # Just demonstrate aggregation. Extend for LaTeX table exports.
